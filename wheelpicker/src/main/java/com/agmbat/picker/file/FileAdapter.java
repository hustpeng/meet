...
import com.agmbat.picker.util.CompatUtils;
import com.agmbat.picker.util.ConvertUtils;
import com.agmbat.picker.util.FileUtils;
...
public class FileAdapter extends BaseAdapter {
    ...
    public View getView(int position, View convertView, ViewGroup parent) {
        ...
        if (convertView == null) {
            ...
            int height = (int) SysResources.dipToPixel(itemHeight);
            ...
            int padding = (int) SysResources.dipToPixel(5);
            layout.setPadding(padding, padding, padding, padding);

            ImageView imageView = new ImageView(context);
            int wh = (int) SysResources.dipToPixel(30);
            ...
            tvParams.leftMargin = (int) SysResources.dipToPixel(10);
