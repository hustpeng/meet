package com.agmbat.picker.popup;
...
public abstract class ConfirmPopup<V extends View> extends BasicPopup<View> {
    ...
    protected final View makeContentView() {
        ...
        if (contentLeftAndRightPadding > 0) {
            lr = (int) SysResources.dipToPixel(contentLeftAndRightPadding);
        }
        if (contentTopAndBottomPadding > 0) {
            tb = (int) SysResources.dipToPixel(contentTopAndBottomPadding);
        }
    ...
    protected View makeHeaderView() {
        ...
        int height = (int) SysResources.dipToPixel(topHeight);
        ...
        int padding = (int) SysResources.dipToPixel(topPadding);
