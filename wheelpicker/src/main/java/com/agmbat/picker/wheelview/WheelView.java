 ...
 * <p/>
 * 基于ScrollView，参见https://github.com/wangjiegulu/WheelView
 * 基于ListView，参见https://github.com/venshine/WheelView
 * 基于View，参见https://github.com/weidongjian/androidWheelView
 */
public class WheelView extends View {
    ...
    public void setTextPadding(int textPadding) {
        this.textPadding = (int) SysResources.dipToPixel(textPadding);
    }
    ...
    private void remeasure() {
        ...
        if (useWeight) {
            ...
            if (textPadding < 0) {
                textPadding = (int) SysResources.dipToPixel((int) ITEM_PADDING);
            }
    ...
    private void measuredCenterContentStart(String content) {
        ...
        switch (gravity) {
            case Gravity.CENTER://显示内容居中
                ...
                break;
            case Gravity.LEFT:
                drawCenterContentStart = (int) SysResources.dipToPixel(8);
                break;
    ...
    private void measuredOutContentStart(String content) {
        ...
        switch (gravity) {
            case Gravity.CENTER:
                ...
                break;
            case Gravity.LEFT:
                drawOutContentStart = (int) SysResources.dipToPixel(8);
                break;
            case Gravity.RIGHT:
