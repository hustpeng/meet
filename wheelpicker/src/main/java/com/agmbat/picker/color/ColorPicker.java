package com.agmbat.picker.color;
...
public class ColorPicker extends ConfirmPopup<LinearLayout> {
    ...
    private View createTitleView(Activity activity) {
        ...
        int height = (int) SysResources.dipToPixel(28);
        RelativeLayout.LayoutParams params = new RelativeLayout.LayoutParams(WRAP_CONTENT, height);
        int margin = (int) SysResources.dipToPixel(topPadding);
    ...
    protected LinearLayout makeCenterView() {
        ...
        multiColorView = new ColorPanelView(mContext);
        ...
        blackColorView = new ColorPanelView(mContext);
        blackColorView.setId(BLACK_ID);
        blackColorView.setLayoutParams(new LinearLayout.LayoutParams(MATCH_PARENT, (int) SysResources.dipToPixel(30)));
