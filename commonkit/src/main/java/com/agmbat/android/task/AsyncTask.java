...
public abstract class AsyncTask<Params, Progress, Result> {
    ...
    private static final BlockingQueue<Runnable> sDefaultPoolWorkQueue = new LinkedBlockingQueue<Runnable>(10);
    ...
    public static final Executor DEFAULT_THREAD_POOL_EXECUTOR = new ThreadPoolExecutor(NORMAL_POOL_SIZE,
            MAXIMUM_POOL_SIZE, KEEP_ALIVE, TimeUnit.SECONDS, sDefaultPoolWorkQueue, sThreadFactory);
    ...
    private static class LowPriorityThread extends Thread implements Executor {
        ...
        @Override
        public void run() {
            setThreadPrioritySafe(Process.THREAD_PRIORITY_BACKGROUND + (5 * Process.THREAD_PRIORITY_LESS_FAVORABLE));
            while (!isInterrupted()) {
                try {
