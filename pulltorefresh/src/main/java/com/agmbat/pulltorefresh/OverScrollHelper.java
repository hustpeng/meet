...
public final class OverScrollHelper {
    ...
    public static void overScrollBy(PullToRefreshBase<?> view, int deltaX, int scrollX,
                                    int deltaY, int scrollY, boolean isTouchEvent) {
     ...
     */
    public static void overScrollBy(PullToRefreshBase<?> view, int deltaX, int scrollX,
                                    int deltaY, int scrollY, int scrollRange, boolean isTouchEvent) {
    ...
    public static void overScrollBy(PullToRefreshBase<?> view, int deltaX, int scrollX,
                                    ...
                                    float scaleFactor, boolean isTouchEvent) {
        final int deltaValue;
        final int currentScrollValue;
            ...
            if (mode.permitsPullToRefresh() && !isTouchEvent && deltaValue != 0) {
                ...
                if (newScrollValue < (0 - fuzzyThreshold)) {
                    ...
                    if (mode.showFooterLoadingLayout()) {
                        ...
                        int value = (int) (scaleFactor * (currentScrollValue + newScrollValue - scrollRange));
                        view.setHeaderScroll(value);
                    }
