...
public class TabLayout extends HorizontalScrollView {
     ...
     *
     * @param viewPager
     * @param initTabs  是否初始化tab
     */
    public void setupWithViewPager(ViewPager viewPager, boolean initTabs) {
    ...
    private class SlidingTabStrip extends LinearLayout {
        ...
        void setIndicatorPositionFromTabPosition(int position, float positionOffset) {
            if (!mIsIndicatorScrollable && mHasInit) {
                return;
            }
        ...
        public void draw(Canvas canvas) {
            ...
            if (mIndicatorLeft >= 0 && mIndicatorRight > mIndicatorLeft) {
                canvas.drawRect(mIndicatorLeft, (float) (getHeight() - mSelectedIndicatorHeight), mIndicatorRight,
