...
import com.agmbat.db.converter.ColumnConverter;
...
public final class ColumnEntity {
    ...
    public Object getColumnValue(Object entity) {
        ...
        return columnConverter.fieldValueToDbValue(fieldValue);
    }
     ...
     * @return
     */
    public KeyValue columnToKeyValue(Object entity) {
        KeyValue kv = null;
        if (isAutoId()) {
            return null;
        }
        String key = getColumnName();
        if (key != null) {
