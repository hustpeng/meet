...
import com.agmbat.db.table.ColumnUtils;
...
public class WhereBuilder {
    ...
    private void appendCondition(String conj, String columnName, String op, Object value) {
        ...
        // append columnName
        appendColumnName2(builder, columnName);
        // convert op
        if ("!=".equals(op)) {
            op = "<>";
        } else if ("==".equals(op)) {
            ...
            if ("IN".equalsIgnoreCase(op)) {
                ...
                if (items != null) {
                    ...
                    for (Object item : items) {
                        Object itemColValue = ColumnUtils.convertToDbValueIfNeeded(item);
                ...
                if (items != null) {
                    ...
                    Object startColValue = ColumnUtils.convertToDbValueIfNeeded(start);
                    Object endColValue = ColumnUtils.convertToDbValueIfNeeded(end);
                ...
                value = ColumnUtils.convertToDbValueIfNeeded(value);
