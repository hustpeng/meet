...
public class ImageCropActivity extends ImageBaseActivity implements View.OnClickListener, CropImageView.OnBitmapSaveCompleteListener {
    ...
    protected void onCreate(Bundle savedInstanceState) {
        ...
        PickerOption.CropParams cropParams = imagePicker.getPickerOption().getCropParams();
        ...
        //获取需要的参数
        mOutputX = cropParams.getOutPutX();
        mOutputY = cropParams.getOutPutY();
        ...
        mCropImageView.setFocusStyle(cropParams.getStyle());
        mCropImageView.setFocusWidth(cropParams.getFocusWidth());
        mCropImageView.setFocusHeight(cropParams.getFocusHeight());
