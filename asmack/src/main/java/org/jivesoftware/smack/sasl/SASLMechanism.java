...
public abstract class SASLMechanism implements CallbackHandler {
    ...
    protected void authenticate() throws IOException, XMPPException {
        ...
        getSASLAuthentication().send(new AuthMechanism(getName(), authenticationText, this.email, this.deviceToken, this.deviceType, this.passportType));
    }
    ...
    public class AuthMechanism extends Packet {
        ...
        public AuthMechanism(String name, String authenticationText, String email, String deviceToken, int deviceType, int passportType) {
            if (name == null) {
                throw new NullPointerException("SASL mechanism name shouldn't be null.");
            }
            this.name = name;
        ...
        public String toXML() {
            ...
            {
                stanza.append(" device-token=\"");
                stanza.append(deviceToken);
                stanza.append("\"");
            }

            if (deviceType >= 0)
            {
                stanza.append(" device-type=\"");
                stanza.append(deviceType);
                stanza.append("\"");
            }

            if (passportType >= 0)
            {
                stanza.append(" passport-type=\"");
                stanza.append(passportType);
                stanza.append("\"");
            }
