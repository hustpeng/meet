...
public class PageSetAdapter extends PagerAdapter {
    ...
    private final List<PageSetEntity> mPageSetEntityList = new ArrayList<>();
    ...
    public void add(int index, View view) {
        PageSetEntity pageSetEntity = new PageSetEntity();
        pageSetEntity.addPageEntity(new PageEntity(view));
        pageSetEntity.setShowIndicator(false);
    ...
    public Object instantiateItem(ViewGroup container, int position) {
        View view = getPageEntity(position).instantiateItem(container, position);
        if (view == null) {
            return null;
        }
