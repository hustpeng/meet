...
public final class QRCodeEncoder {
    ...
    private boolean encodeContentsFromZXingIntent(Intent intent) {
        ...
        if (format == null || format == BarcodeFormat.QR_CODE) {
            ...
            if (data != null && !data.isEmpty()) {
                ...
                title = AppResources.getString(R.string.contents_text);
            }
        }
    ...
    private void encodeFromStreamExtra(Intent intent) throws WriterException {
        ...
        try {
            stream = SystemManager.getContentResolver().openInputStream(uri);
            if (stream == null) {
        ...
        switch (type) {
            ...
            case Contents.Type.EMAIL: {
                ...
                if (data != null) {
                    ...
                    displayContents = data;
                    title = AppResources.getString(R.string.contents_email);
                }
                break;
            }
            case Contents.Type.PHONE: {
                ...
                if (data != null) {
                    ...
                    title = AppResources.getString(R.string.contents_phone);
                }
                break;
            }
            case Contents.Type.SMS: {
                ...
                if (data != null) {
                    contents = "sms:" + data;
                    displayContents = PhoneNumberUtils.formatNumber(data);
                    title = AppResources.getString(R.string.contents_sms);
                }
                break;
            }
            case Contents.Type.CONTACT: {
                ...
                if (bundle != null) {
                    ...
                    if (!encoded[1].isEmpty()) {
                        ...
                        title = AppResources.getString(R.string.contents_contact);
                    }
            ...
            case Contents.Type.LOCATION: {
                ...
                if (bundle != null) {
                    ...
                    if (latitude != Float.MAX_VALUE && longitude != Float.MAX_VALUE) {
                        ...
                        title = AppResources.getString(R.string.contents_location);
                    }
                }
                break;
            }
    ...
    private void encodeQRCodeContents(AddressBookParsedResult contact) {
        ContactEncoder encoder = useVCard ? new VCardContactEncoder() : new MECARDContactEncoder();
        String[] encoded =
                encoder.encode(toList(contact.getNames()), contact.getOrg(), toList(contact.getAddresses()),
