...
/**
 * Barcode Scanner can share data like contacts and bookmarks by displaying a QR Code on screen, such that another user
 * can scan the barcode with their phone.
 *
...
public final class ShareActivity extends Activity {
     ...
     * intent to render it as a QR Code.
     *
    ...
    private void showContactAsBarcode(Uri contactUri) {
        ...
        Cursor methodsCursor =
                resolver.query(ContactsContract.CommonDataKinds.StructuredPostal.CONTENT_URI, null,
