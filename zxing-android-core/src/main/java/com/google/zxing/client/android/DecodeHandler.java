...
public final class DecodeHandler extends Handler {
    ...
    public void handleMessage(Message message) {
        ...
        if (what == MsgWhat.DECODE) {
            decode((byte[]) message.obj, message.arg1, message.arg2);
        } else if (what == MsgWhat.QUIT) {
            running = false;
    ...
    private void decode(byte[] data, int width, int height) {
        ...
        if (rawResult != null) {
            ...
            if (handler != null) {
                Message message = Message.obtain(handler, MsgWhat.DECODE_SUCCEEDED, rawResult);
            ...
            if (handler != null) {
                Message message = Message.obtain(handler, MsgWhat.DECODE_FAILED);
                message.sendToTarget();
            }
        }
    }
