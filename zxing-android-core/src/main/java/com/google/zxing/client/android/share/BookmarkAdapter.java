...
/**
 * A custom adapter designed to fetch bookmarks from a cursor. Before Honeycomb we used SimpleCursorAdapter, but it
 * assumes the existence of an _id column, and the bookmark schema was rewritten for HC without one. This caused the app
