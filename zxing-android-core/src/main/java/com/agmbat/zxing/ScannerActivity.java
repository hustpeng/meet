...
import com.google.zxing.client.android.MsgWhat;
 ...
 * @author Sean Owen
 */
public final class ScannerActivity extends Activity implements SurfaceHolder.Callback, DecodeHandler.IActivity {
    ...
    public void onCreate(Bundle icicle) {
        ...
        ScannerConfig.setIsPortrait(true);
...
//        });
    ...
    private void decodeOrStoreSavedBitmap(Bitmap bitmap, Result result) {
        ...
        if (handler == null) {
            ...
            if (savedResultToShow != null) {
                Message message = Message.obtain(handler, MsgWhat.DECODE_SUCCEEDED, savedResultToShow);
    ...
    public void handleDecode(Result rawResult, Bitmap barcode, float scaleFactor) {
        ...
        callbackData(rawResult.toString());
    }

    private void callbackData(String result) {
        mIntent = new Intent();
        mIntent.putExtra(QR_CONTENT, result);
        setResult(QR_SUCCESS, mIntent);
        finish();
    }
    ...
    /*
     * private void displayFrameworkBugMessageAndExit() { AlertDialog.Builder builder = new AlertDialog.Builder(this);
     * builder.setTitle(getString(R.string.app_name)); builder.setMessage(getString(R.string.msg_camera_framework_bug));
     * builder.setPositiveButton(R.string.button_ok, new FinishListener(this)); builder.setOnCancelListener(new
     * FinishListener(this)); builder.show(); }
     */

    public void restartPreviewAfterDelay(long delayMS) {
        if (handler != null) {
            handler.sendEmptyMessageDelayed(MsgWhat.RESTART_PREVIEW, delayMS);
        }
        resetStatusView();
    }
